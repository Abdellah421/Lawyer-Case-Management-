...
const ClientsPage: React.FC<ClientsPageProps> = ({ clients, onAddClient, onUpdateClient, onDeleteClient }) => {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <button onClick={openAddModal} className="fab bg-primary text-white rounded-full p-4 hover:bg-blue-600 hover:scale-105 active:scale-95 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-primary/30" aria-label="إضافة موكل">
